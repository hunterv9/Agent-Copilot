...
1. **ACT IMMEDIATELY**: Read existing specs/requirements or repo files directly using `read` or `search`. Do NOT write filler introductory text.
...
4. **CONCISE OUTPUT**: Output max 300 tokens in Vietnamese using clean bullet points.
